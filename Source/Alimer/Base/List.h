...
namespace Alimer
{
	...
	struct ALIMER_API ListNodeBase
	{
		/// Construct.
		ListNodeBase() :
			prev(nullptr),
	...
	struct ALIMER_API ListIteratorBase
	{
		/// Construct.
		ListIteratorBase() :
			ptr(nullptr)
	...
	public:
		...
		{
			Alimer::Swap(ptrs, list.ptrs);
			Alimer::Swap(allocator, list.allocator);
		}
