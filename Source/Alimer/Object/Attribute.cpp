...
template<> ALIMER_API AttributeType AttributeImpl<bool>::Type() const
{
    return ATTR_BOOL;
}

template<> ALIMER_API AttributeType AttributeImpl<int>::Type() const
{
    return ATTR_INT;
}

template<> ALIMER_API AttributeType AttributeImpl<unsigned>::Type() const
{
    return ATTR_UNSIGNED;
}

template<> ALIMER_API AttributeType AttributeImpl<unsigned char>::Type() const
{
    return ATTR_BYTE;
}

template<> ALIMER_API AttributeType AttributeImpl<float>::Type() const
{
    return ATTR_FLOAT;
}

template<> ALIMER_API AttributeType AttributeImpl<String>::Type() const
{
    return ATTR_STRING;
}

template<> ALIMER_API AttributeType AttributeImpl<Vector2>::Type() const
{
    return ATTR_VECTOR2;
}

template<> ALIMER_API AttributeType AttributeImpl<Vector3>::Type() const
{
    return ATTR_VECTOR3;
}

template<> ALIMER_API AttributeType AttributeImpl<Vector4>::Type() const
{
    return ATTR_VECTOR4;
}

template<> ALIMER_API AttributeType AttributeImpl<Quaternion>::Type() const
{
    return ATTR_QUATERNION;
}

template<> ALIMER_API AttributeType AttributeImpl<Color>::Type() const
{
    return ATTR_COLOR;
}

template<> ALIMER_API AttributeType AttributeImpl<BoundingBox>::Type() const
{
    return ATTR_BOUNDINGBOX;
}

template<> ALIMER_API AttributeType AttributeImpl<ResourceRef>::Type() const
{
    return ATTR_RESOURCEREF;
}

template<> ALIMER_API AttributeType AttributeImpl<ResourceRefList>::Type() const
{
    return ATTR_RESOURCEREFLIST;
}

template<> ALIMER_API AttributeType AttributeImpl<ObjectRef>::Type() const
{
    return ATTR_OBJECTREF;
}

template<> ALIMER_API AttributeType AttributeImpl<JSONValue>::Type() const
{
